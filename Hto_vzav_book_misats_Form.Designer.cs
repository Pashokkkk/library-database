...
namespace Librarry
{
	partial class Hto_vzav_book_misats_Form
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.label2.Size = new System.Drawing.Size(704, 36);
			this.label2.TabIndex = 4;
			this.label2.Text = "Хто з читачів взяв книгу більше місяця тому";
			// 
			// dataGridView1
			// 
			...
			this.Name = "Hto_vzav_book_misats_Form";
			this.Load += new System.EventHandler(this.Hto_vzav_book_misats_Form_Load);
